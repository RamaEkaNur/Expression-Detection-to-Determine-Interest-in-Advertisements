...
# # Load the model
# model_path = 'C:/Users/Rama Eka/Documents/Tugas/semester 7/comvis/test/skripsi/best.pt'
...
#         # Initialize variables to store classification results for the current frame
#         classifications = []
...
#                 classifications.append((original_label, conf.item()))

#         # End timer for computation time
#         end_time = time.time()
#         computation_time_ms = (end_time - start_time) * 1000  # Convert to milliseconds
...
#             print(f'Time: {current_time}, FPS: {fps:.2f}, Classification: {label}, Confidence: {confidence:.2f}, Computation Time: {computation_time_ms:.2f}ms')

#             # Save output data to the list
#             output_data.append([current_time, fps, label, confidence, computation_time_ms])
...
#         # Write header row
#         writer.writerow(["Time", "FPS", "Classification", "Confidence", "Computation Time (ms)"])
#         # Write all rows
